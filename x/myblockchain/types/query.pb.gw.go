...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2}, []string{"cosmonaut", "myblockchain", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Posts_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2}, []string{"cosmonaut", "myblockchain", "posts"}, "", runtime.AssumeColonVerbOpt(true)))
)
